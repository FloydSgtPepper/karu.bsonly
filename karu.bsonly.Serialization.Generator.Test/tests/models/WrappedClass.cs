...
class WrappedClass : ISerializable
{
  ...
  public void Deserialize(IDocumentDeserializer reader)
  {
    ...
    object? value = null;
    Serializer.Serialize(reader, "InnerClass"u8, ref value, typeof(WrappedClassInner));
    this.InnerClass = (value ?? new WrappedClassInner()) as WrappedClassInner ?? new WrappedClassInner();
  ...
  public void Serialize(IDocumentSerializer writer)
  {
    ...
    Serializer.Serialize(writer, "InnerClass"u8, this.InnerClass);
