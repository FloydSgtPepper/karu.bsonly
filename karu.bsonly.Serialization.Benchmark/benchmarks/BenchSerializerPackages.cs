...
//   [ThreadingDiagnoser]
//   [ExceptionDiagnoser]
//   public class BenchSerializerPackages
//   {
...
//     public BenchSerializerPackages()
//     {
...
//       _memory_reader = new MemoryDocReader(_bson_doc_read, BsonSettings.BSON_API.MaxSize, BsonSettings.BSON_API.OutOfOrderEvaluation);
...
//     [Benchmark]
//     public void Serialize_MongoWriter()
//     {
//       _bson_doc_write = _tc_serializable.ToBson();
//     }
//     [Benchmark]
//     public void Serialize_MongoReader()
//     {
//       _tc_deserializable = MongoDB.Bson.Serialization.BsonSerializer.Deserialize<TestClassISerializable>(_bson_doc_read);
//     }


//     private void Deserialize(IBasicDeserializer deserializer, DeserializationContext context, ISerializable value)
//     {
//       try
//       {
